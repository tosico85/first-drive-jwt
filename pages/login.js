          ...
          >
            ...
            <div className="flex w-full">
              <button
                ...
                className="py-2 px-4  bg-mainBlue hover:bg-blue-700 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
              >
